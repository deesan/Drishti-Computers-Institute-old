...
Public Class Admin_main
    ...
    Private Sub UserMenu1_Click(sender As Object, e As EventArgs) Handles UserMenu1.Click
        Me.Text = String.Format("{0} - Drishti Computer Institute", frmManageUser.Text)
        lblSoftName.Text = String.Format("{0} - Drishti Computer Institute", frmManageUser.Text)
        frmManageUser.lblUserID.Text = lblUserID.Text
        frmManageUser.lblUserName.Text = lblUserName.Text
        frmManageUser.Reset()
        switchpanel(frmManageUser)
    End Sub
    ...
    Private Sub AdmissionCancelMenu1_Click(sender As Object, e As EventArgs) Handles AdmissionCancelMenu1.Click
        Me.Text = String.Format("{0} - Drishti Computer Institute", FrmAdmissioncancel.Text)
        lblSoftName.Text = String.Format("{0} - Drishti Computer Institute", FrmAdmissioncancel.Text)
        FrmAdmissioncancel.lbluserID.Text = lblUserID.Text
        FrmAdmissioncancel.lblUserName.Text = lblUserName.Text
        FrmAdmissioncancel.Reset()
        switchpanel(FrmAdmissioncancel)
    End Sub
    ...
    Private Sub UsersMenu2_Click(sender As Object, e As EventArgs) Handles UsersMenu2.Click
        Me.Text = String.Format("{0} - Drishti Computer Institute", frmManageUser.Text)
        lblSoftName.Text = String.Format("{0} - Drishti Computer Institute", frmManageUser.Text)
        frmManageUser.lblUserID.Text = lblUserID.Text
        frmManageUser.lblUserName.Text = lblUserName.Text
    ...
    Private Sub LogsMenu2_Click(sender As Object, e As EventArgs) Handles LogsMenu2.Click
        Me.Text = String.Format("{0} - Drishti Computer Institute", frmLogs.Text)
        lblSoftName.Text = String.Format("{0} - Drishti Computer Institute", frmLogs.Text)
        frmLogs.lblUserID.Text = lblUserID.Text
        frmLogs.lblUsername.Text = lblUserName.Text
        frmLogs.Reset()
        switchpanel(frmLogs)
    End Sub
    ...
    Private Sub AdmissionCancelMenu2_Click(sender As Object, e As EventArgs) Handles AdmissionCancelMenu2.Click
        Me.Text = String.Format("{0} - Drishti Computer Institute", FrmAdmissioncancel.Text)
        lblSoftName.Text = String.Format("{0} - Drishti Computer Institute", FrmAdmissioncancel.Text)
        FrmAdmissioncancel.Close()
        FrmAdmissioncancel.lbluserID.Text = lblUserID.Text
