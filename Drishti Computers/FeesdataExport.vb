...
Public Class FeesdataExport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Drishti_Computers.FeesdataExport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFeesdataExport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FeesdataExport = New FeesdataExport()
        rpt.Site = Me.Site
        Return rpt
    End Function
